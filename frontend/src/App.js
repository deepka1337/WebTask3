    ...
    <div className="bg-slate-900 text-white h-screen relative">
      <div className="flex flex-col w-full p-10">
        ...
        <input
          ...
          type="text"
          className="w-full py-2 rounded-xl bg-slate-700 text-white outline-none" placeholder="Добавить задачу..."/>
        ...
        <div className="mt-5 flex flex-col space-y-5 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-10 lg:grid-cols-3">
          {todos?.map((todo, index) => ( 
            ...
            <p onClick={() =>{
              ...
              {""}
              {todo.status && (
                  <span className='test-xs text-gray-300'>(Выполнено)</span>
                )}
            </p>
        ...
        <div          
          ...
          <div className="flex items justify-between">
            <h1 className="text-xl mb-2">Введите задачу</h1>
          ...
          <div className="flex items-center h-5 w-full space-x-2 mb-4">
            ...
            <div>
            <input type="text" className="w-full px-3 py-2 bg-gray-300 rounded-xl" 
              placeholder="Введите имя" value={editName} onChange={(e) => setEditName(e.target.value)} />
            </div>
